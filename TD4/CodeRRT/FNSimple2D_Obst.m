classdef FNSimple2D_Obst < handle
    ...
    methods
        ...
        function position = sample(this)
            ...
            rand_obs = randi([1 2]); %ajouter comme critere le nombre d'obstacles
            rand_coins = randi([1 5]); %ajouter comme critere le nombre de coins
            this.iteration_value = this.iteration_value + 1;
            dado = this.iteration_value
            position = [this.obstacle.output{rand_obs}(rand_coins,1); this.obstacle.output{rand_obs}(rand_coins,2)]
            %%%%%%%%
